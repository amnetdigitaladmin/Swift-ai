...
import { FileText, Palette, Code, CheckCircle, ArrowRight, Eye, LogOut, Plus, FolderOpen } from "lucide-react";
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <span className="text-cyan-400 font-medium">{currentProject.name}</span>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-400 mb-8">
                Access all AI agents across requirements, development, and QA phases. 
                  ...
                  {projects.map((project) => (
                    ...
                    >
                      <CardHeader className="pb-3">
                        <CardTitle className="text-lg text-gray-200">{project.name}</CardTitle>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-200 mb-2">Testing</h3>
